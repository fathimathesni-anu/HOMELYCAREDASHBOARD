            ...
            <img
              src={
                ...
                (profilePic
                  ...
                  : `https://ui-avatars.com/api/?name=${encodeURIComponent(doctor.name || 'Doctor')}&background=random&size=128`)
              }
              alt="Profile"
              className="h-8 w-8 rounded-full object-cover border"
            />
            <span className="text-gray-700 dark:text-white">{doctor.name || 'Doctor'}</span>
            ...
            <div className="absolute top-12 right-0 w-64 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-md shadow-lg z-50 p-4 space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 rounded-full overflow-hidden border">
                  <img
                    src={preview || (profilePic ? `/doctor/uploads/${profilePic}` : `https://ui-avatars.com/api/?name=${doctor.name}&background=random&size=128`)}
                    alt="Preview"
