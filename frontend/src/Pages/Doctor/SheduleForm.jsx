...
const ScheduleForm = ({
  ...
  return (
    <form
      ...
      className="space-y-6 mt-6 border p-6 rounded-lg shadow-md bg-white max-w-lg mx-auto"
    >
      <div>
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-6 gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-0">
        <button
          type="submit"
          className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white rounded-md px-6 py-2 transition"
        >
        ...
        {scheduleIndex !== null && (
          <button
            ...
            className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white rounded-md px-6 py-2 transition"
          >
            Delete
          </button>
        )}
