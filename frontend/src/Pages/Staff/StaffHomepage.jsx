    ...
    <div className="p-6 bg-white dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link to="/staff/dashboard/staff">
          <div className="p-4 bg-blue-100 dark:bg-blue-800 rounded-lg shadow hover:shadow-md transition duration-200 cursor-pointer">
        ...
        <Link to="/staff/dashboard/tasks">
          <div className="p-4 bg-green-100 dark:bg-green-800 rounded-lg shadow hover:shadow-md transition duration-200 cursor-pointer">
        ...
        <Link to="/staff/dashboard/staff">
          <div className="p-4 bg-yellow-100 dark:bg-yellow-700 rounded-lg shadow hover:shadow-md transition duration-200 cursor-pointer">
