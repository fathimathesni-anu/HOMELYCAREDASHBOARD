...
const NotificationList = () => {
  ...
  return (
    <div className="notification-list max-w-3xl mx-auto p-4 sm:p-6 space-y-6">
      <form
      ...
      >
        <input
          ...
          className="border p-3 rounded-md flex-grow w-full sm:w-auto focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
          required
        />
        <button
          type="submit"
          className="px-5 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition flex-shrink-0"
        >
        ...
        {editingNotification && (
          <button
            ...
            className="px-5 py-3 bg-gray-400 text-white rounded-md hover:bg-gray-500 transition flex-shrink-0"
          >
            Cancel
          </button>
        )}
