...
import { useroleSignup, useroleLogin,useroleProfile,useroleLogout ,getAllUsers, getAllStaffs} from "../controllers/userolecontrollers.js";
...
router.get('/staffs', useroleAuth, authorizeRoles('admin', 'staff','doctor'), getAllStaffs);
